...
int main(void)
{
	...
	int diff1 = user_time_to_mins - dep1_to_mins;i
    //TIP: we could have used the "abs" function in stdlib.h to turn all integers positive.
	...
	case 8:
		...
		break;
	default:
        //TIP: this will not be reachable since dep will only be assigned values 1-8, but the default case should be left in here anyways in case the code is modified later to have more times added to the flight schedule.
